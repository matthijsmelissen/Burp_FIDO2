...
public class SignCountTest extends WebAuthnTest {
    public SignCountTest(MontoyaApi api, String testType) {
        this.api = api;
        this.testName = "Signature Counter";
...
//        Update signature count to 1
        String newAuthenticatorData = Util.changeSignCount(authenticatorData, 1, rpIdHash);
