...
public class ClientDataCrossOriginTest extends WebAuthnTest {
    public ClientDataCrossOriginTest(MontoyaApi api, String testType) {
        this.api = api;
        this.testName = "Client Data cross origin";
...
//        TODO check this case
        clientDataJSON.put(Const.CROSS_ORIGIN, true);
