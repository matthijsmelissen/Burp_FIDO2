...
public class UserPresenceVerificationTest extends WebAuthnTest {
    public UserPresenceVerificationTest(MontoyaApi api, String testType) {
        this.api = api;
        this.testName = "User Presence and User Verification";
...
//            Change UP and UV bits to 0
                cborArray[index + rpIdHash.length] = (byte) (flags & 0b11111010);
