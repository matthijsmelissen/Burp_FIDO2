...
public class ClientDataOriginPathTest2 extends WebAuthnTest {
    public ClientDataOriginPathTest2(MontoyaApi api, String testType) {
        this.api = api;
        this.testName = "Client Data origin path \"/\"";
    ...
    public HttpResponse execute(HttpRequest request) {
        ...
        try {
            ...
            String testOriginPath = url.getProtocol() + "://" + url.getHost() + "/";
